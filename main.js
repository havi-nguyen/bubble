...
document.addEventListener('keydown', (event) => {
    switch (event.code) {
        case 'KeyW': movement.forward = -1; break; // Move closer to the bubble
        case 'KeyS': movement.forward = 1; break; // Move farther from the bubble
        case 'KeyA': movement.sideways = -1; break; // Rotate left
        case 'KeyD': movement.sideways = 1; break; // Rotate right
        case 'Space': movement.vertical = 1; break; // Move up
        case 'ShiftLeft': movement.vertical = -1; break; // Move down
    }
});
...
document.addEventListener('keyup', (event) => {
    switch (event.code) {
        ...
        case 'KeyA': case 'KeyD': movement.sideways = 0; break;
        case 'Space': case 'ShiftLeft': movement.vertical = 0; break;
    }
});
